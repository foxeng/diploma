...
\title{
	\vspace*{-8ex}
	\begin{center}
		\includegraphics[scale=0.4]{img/pyrforos.eps}
	\end{center}
	\Large{Ε}\large{ΘΝΙΚΟ}
	...
	\normalsize{Υ}\small{ΠΟΛΟΓΙΣΤΩΝ} \\
	\vspace{14ex}
	\large\textbf{Κοινόχρηστο με τον \en{host} σύστημα αρχείων σε \en{unikernel}} \\
	\vspace{14ex}
...
\begin{minipage}{3.0cm}
	\includegraphics[height=2.5cm]{img/pyrforos}
\end{minipage}
